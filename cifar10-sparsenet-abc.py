...
def get_config():
    log_dir = 'train_log/cifar10-bc-attention-k[%d]-path[%d]-[%d-%d-%d-%d]-' % ( int(args.k), int(args.path), int(args.block1), int(args.block2),int(args.block3), int(args.block4))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--k', default=30, help='number of output feature maps for each dense block')
    parser.add_argument('--path', default=28,help='number of paths to each layer')#12
