...
def get_config():
    log_dir = 'train_log/svhn-bc-attention-k[%d]-path[%d]-[%d-%d-%d-%d]-' % ( int(args.k), int(args.path), int(args.block1), int(args.block2),int(args.block3), int(args.block4))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--drop_1',default=20, help='Epoch to drop learning rate to 0.01.') # nargs='*' in multi mode
    parser.add_argument('--drop_2',default=30,help='Epoch to drop learning rate to 0.001')
    parser.add_argument('--drop_3',default=40,help='Epoch to drop learning rate to 0.0002')
    parser.add_argument('--max_epoch',default=40,help='max epoch')
